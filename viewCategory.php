...
<div class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
        <div class="table-responsive">
            <table class="table table-striped">
                ...
                <?php
                 $fetch="SELECT cat_id, cat_name, cat_image FROM categories";
                ...
                ?>
                    ...
                    <tr>
                        ...
                        <td><img src="<?php echo $row['cat_image'] ?>" alt="" style="height:35px; width:35px; border-radius:50%;"></td>
                        <td>
                            <a href="editCategory.php?id=<?php echo $row['cat_id'] ?>" class="table-action-btns text-prmaryi mr-2" title="Edit Category"><i class="fas fa-edit"></i></a>
                            <a href="deleteCategory.php?id=<?php echo $row['cat_id']?>" class="table-action-btns text-danger" title="Delete Category"><i class="fas fa-trash"></i></a>
                        </td>
                    </tr>
                 <?php
                }
