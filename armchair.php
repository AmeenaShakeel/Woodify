...
<div class="big-shop" id="new_stock">
         <div class="shop-title">
            ...
            <p style="font-weight: 500;">
                "An armchair is more than a seat; it’s a sanctuary, a retreat from the world." 
            </p>
        </div>

    <div class="product-flex ">
    <?php
        $product = "SELECT prod_id , prod_name, prod_image, prod_price FROM products WHERE category_id = '3'";
...
<?php 
    $video = "SELECT prod_video FROM products WHERE category_id = '3' AND prod_video != '' ";
