...
<div class="big-shop" id="new_stock">
         <div class="shop-title">
            ...
            <p style="font-weight: 500;">
                "The perfect antidote to a long day is a cozy couch and a good book." 
            </p>
        </div>

    <div class="product-flex ">
    <?php
        $product = "SELECT prod_id , prod_name, prod_image, prod_price FROM products WHERE category_id = '4'";
...
<?php 
    $video = "SELECT prod_video FROM products WHERE category_id = '4' AND prod_video != '' ";
