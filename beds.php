...
<div class="big-shop" id="new_stock">
         <div class="shop-title">
            ...
            <p style="font-weight: 500;">
                "A bed is the most important place in the world." 
            </p>
        </div>
      
    <div class="product-flex ">
    <?php
        $product = "SELECT prod_id , prod_name, prod_image, prod_price FROM products WHERE category_id = '2'";
    ...
    <?php 
    $video = "SELECT prod_video FROM products WHERE category_id = '2' AND prod_video != '' ORDER BY prod_id DESC LIMIT 1 ";
