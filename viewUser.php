...
<div class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
        <div class="table-responsive">
            <table class="table table-striped">
                ...
                <?php
                 $fetch="SELECT id, username, password FROM logged_user";
                ...
                ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="editUser.php?id=<?php echo $row['id'] ?>" class="table-action-btns text-prmaryi mr-2" title="Edit User"><i class="fas fa-edit"></i></a>
                            <a href="deleteuser.php?id=<?php echo $row['id']?>" class="table-action-btns text-danger" title="Delete User"><i class="fas fa-trash"></i></a>
                        </td>
                    </tr>
                 <?php
                }
